...
import { findUserById } from '../access-database/user.model.js';
...
//     <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">SOS APP</a>
//   </div>
//   <p style="font-size:1.1em">Hi,</p>
//   <p>Thank you for choosing SOS APP. OTP is valid for 1 minutes</p>
//   <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${token}</h2>
//   <p style="font-size:0.9em;">Regards,<br />SOS APP</p>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 14px; font-family: 'Varela Round', 'Trebuchet MS', Helvetica, sans-serif; mso-line-height-alt: 21px; color: #ffffff; line-height: 1.5;">
																		<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">Thank you for choosing SOS APP.</p>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; font-family: 'Varela Round', 'Trebuchet MS', Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #4a60bb; line-height: 1.2;">
																		<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;"><span style>Copyright © 2023 SOS APP, All rights reserved.<br></span></p>
																	</div>
																</div>
															</td>
														</tr>
...
export default async function sendEmail(req, res, next) {
  ...
  transporter.sendMail(mailOptions, (error, info) => {
    if (error) {
      return responseFailed(res, httpStatus.serverInterval, error);
    }
    console.log('Message sent: %s', info.messageId);
    return responseRequest(res, httpStatus.ok, 'Send OTP success');
  });
}
// sendEmail('478332c0-f06e-11ed-b68f-2047475d275a');
